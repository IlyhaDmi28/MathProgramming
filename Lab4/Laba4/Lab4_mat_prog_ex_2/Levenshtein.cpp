...
//длина слова y, слово длиной ly
{
	...
	//длина строки х=i (кол-во символов в слове x), а DD возвращ. саму строку 
...
)
{
	...
	//если длина x = длина y = 1 и первые буквы совапали, дистанция = 0
	else  if (lx == 1 && ly == 1 && x[0] != y[0]) rc = 1; 
	//если длина x = длина y = 1 и первые буквы не совапали, дистанция = 1
	else  rc = min3(
